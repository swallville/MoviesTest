...
export const MovieDetailsResponseContract = zodContract(MovieDetailsResponseSchema);
...
export const MovieVideosResponseContract = zodContract(MovieVideosResponseSchema);
