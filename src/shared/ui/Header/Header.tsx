...
const Header = ({ title = "Pop Movies", defaultBackgroundColor = "primary", goBackButton = true }: HeaderProps) => {
    ...
    return (
        <header className={`w-full ${padding} text-white flex items-center gap-2 ${backgroundColor}`}>
            ...
            <h1 className="text-xl font-bold leading-6">{isNotMainPage ? title : "Movie Details"}</h1>
        </header>
    );
}
